...
<div class="row select-wrap">
    <?=Html::beginTag('div',['class'=>"select-number ".($type=="小组赛"?"op1":"op2")])?>
        <div class="col-xs-6 select-option" onclick="window.open('./?r=site%2Fmatch&type=小组赛','_self')">
            <span>小组赛</span>
        </div>
        <div class = "col-xs-6 select-option" onclick = "window.open('./?r=site%2Fmatch&type=淘汰赛','_self')">
            <span>淘汰赛</span>
        </div>
        <div class="cut"></div>
        <div class ="bg"></div>
